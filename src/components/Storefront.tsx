    ...
    >
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="text-white p-2.5 rounded-xl shadow-md font-extrabold flex items-center gap-1.5 cursor-pointer relative shrink-0 transition-opacity hover:opacity-90"
            >
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex gap-2 overflow-x-auto py-1 no-scrollbar justify-start sm:justify-center scroll-smooth">
            {uniqueCategories.map(cat => (
              <button
                ...
                className={`px-4.5 py-2 rounded-full text-xs font-bold transition-all whitespace-nowrap cursor-pointer border ${
            ...
            {hasHiddenCategories && (
              <button
                onClick={() => setUpgradeOpen(true)}
                className={`px-4.5 py-2 rounded-full text-xs font-bold transition-all whitespace-nowrap cursor-pointer border border-dashed border-amber-300 dark:border-amber-900/60 bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center gap-1 hover:bg-amber-500/20`}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2.5">
                          <div className={`p-0.5 border dark:border-slate-800 rounded-lg flex items-center gap-1.5 ${
                            darkMode ? 'bg-slate-950' : 'bg-slate-50'
                          }`}>
                            <button
                              onClick={() => updateCartQuantity(item.product.id, item.quantity - 1)}
                              className="p-1 rounded-md hover:bg-slate-250 dark:hover:bg-slate-850 text-slate-500 cursor-pointer"
                            >
              ...
              <div className="space-y-4 text-xs sm:text-sm leading-relaxed mb-6">
                ...
                <div className="text-center p-3 rounded-xl bg-slate-100 dark:bg-slate-850">
                  ...
                  <span className="text-2xl font-black text-slate-900 dark:text-white block">
                    $15.00<span className="text-xs font-semibold text-slate-400">/{isRtl ? 'شهرياً' : 'month'}</span>
                  </span>
                </div>
